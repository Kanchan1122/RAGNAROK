...
TELEGRAM_BOT_TOKEN = '7986036175:AAGo_TftaP6k1nE6QRDuqvfjlfUB9myKOck'
ALLOWED_USER_ID = 6062735907
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text="*🚨 End Completed! 🚨*\n*Thank 🚀🚀🚀🚀🚀🚀service!*", parse_mode='Markdown')
